...
int builtins_z(z_Database* rst z_db, char** rst buffer, size_t* rst buf_lens, Arena* arena, Arena* rst scratch);
 ...
 */
[[nodiscard]]
bool builtins_check_and_run(Vm_Data* rst vm, Shell* rst shell, Arena* rst scratch)
{
    if (shell) {
