...
void ac_find_commands_test(void)
{
    ...
    eskilib_assert(search_res != NULL);
    eskilib_assert(search_res->is_end_of_a_word == false);
    ...
    eskilib_assert(search_res != NULL);
    eskilib_assert(search_res->is_end_of_a_word == true);*/
...
void autocompletions_get_test(void)
{
    ARENA_TEST_SETUP;
    ...
    uint_fast32_t match_count = autocompletions_get("ls | ", autocomplete, tree, scratch_arena);
...
void autocompletions_get_no_results_test(void)
{
    ARENA_TEST_SETUP;
    SCRATCH_ARENA_TEST_SETUP;
    ...
    struct Autocompletion autocomplete[NCSH_MAX_AUTOCOMPLETION_MATCHES] = {0};
    uint_fast32_t match_count = autocompletions_get("n", autocomplete, tree, scratch_arena);
...
void autocompletions_get_multiple_test(void)
{
    ARENA_TEST_SETUP;
    SCRATCH_ARENA_TEST_SETUP;
    ...
    match_count = autocompletions_get("l", autocomplete_two, tree, scratch_arena);
...
void autocompletions_get_multiple_simulation_test(void)
{
    ARENA_TEST_SETUP;
    SCRATCH_ARENA_TEST_SETUP;
    ...
    struct Autocompletion autocomplete_two[NCSH_MAX_AUTOCOMPLETION_MATCHES] = {0};
    match_count = autocompletions_get("ls", autocomplete_two, tree, scratch_arena);
...
void autocompletions_tests(void)
{
    ...
    eskilib_test_run(ac_find_test);
    eskilib_test_run(ac_find_no_results_test);
    eskilib_test_run(ac_find_commands_test);
    eskilib_test_run(autocompletions_get_test);
    eskilib_test_run(autocompletions_get_no_results_test);
    eskilib_test_run(autocompletions_get_multiple_test);
    eskilib_test_run(autocompletions_get_multiple_simulation_test);
