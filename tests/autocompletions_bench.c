...
void autocompletions_bench(void)
{
    ...
    autocompletions_add("git restore src/readline/ncsh_readline.c", sizeof("git restore src/readline/ncsh_readline.c"),
                        tree, &arena);
    ...
    autocompletions_add("z rm /home/alex/readline/usr/local", sizeof("z rm /home/alex/readline/usr/local"), tree,
                        &arena);
    autocompletions_add("z rm /home/alex/ncsh/development/cash", sizeof("z rm /home/alex/ncsh/development/cash"), tree,
                        &arena);
    autocompletions_add("z rm /home/alex/ncsh/development/curses", sizeof("z rm /home/alex/ncsh/development/curses"),
                        tree, &arena);
    ...
    autocompletions_add("git push -u origin fuzz-testing-and-longjmp",
                        sizeof("git push -u origin fuzz-testing-and-longjmp"), tree, &arena);
    autocompletions_add("cd ..", sizeof("cd .."), tree, &arena);
    autocompletions_add("git clone https://github.com/a-eski/ncsh.git ./ncsh3",
    ...
    autocompletions_add("git restore src/readline/ncsh_terminal.c", sizeof("git restore src/readline/ncsh_terminal.c"),
                        tree, &arena);
    ...
    autocompletions_add("nvim src/readline/ncsh_autocompletions.c", sizeof("nvim src/readline/ncsh_autocompletions.c"),
                        tree, &arena);
    ...
    autocompletions_add("git commit -m 'trie optimizations: switch back impl'",
    ...
    autocompletions_add("git rm NCSH_AUTOCOMPLETIONS_CORPUS/.gitignore",
                        sizeof("git rm NCSH_AUTOCOMPLETIONS_CORPUS/.gitignore"), tree, &arena);
    autocompletions_add("git rm NCSH_AUTOCOMPLETIONS_CORPUS", sizeof("git rm NCSH_AUTOCOMPLETIONS_CORPUS"), tree,
                        &arena);
    autocompletions_add("git rm NCSH_HISTORY_CORPUS/.gitignore", sizeof("git rm NCSH_HISTORY_CORPUS/.gitignore"), tree,
                        &arena);
    autocompletions_add("git rm NCSH_PARSER_CORPUS/.gitignore", sizeof("git rm NCSH_PARSER_CORPUS/.gitignore"), tree,
                        &arena);
    autocompletions_add("nvim", sizeof("nvim"), tree, &arena);
    ...
    autocompletions_add("git restore *", sizeof("git restore *"), tree, &arena);
    autocompletions_add("git restore tests/ncsh_autocompletions_tests.c",
                        sizeof("git restore tests/ncsh_autocompletions_tests.c"), tree, &arena);
    autocompletions_add("git restore src/readline/ncsh_history.h", sizeof("git restore src/readline/ncsh_history.h"),
                        tree, &arena);
    ...
    autocompletions_add("nvim acceptance_tests/tests/common.rb", sizeof("nvim acceptance_tests/tests/common.rb"), tree,
                        &arena);
    autocompletions_add("ls", sizeof("ls"), tree, &arena);
    autocompletions_add("ls", sizeof("ls"), tree, &arena);
    autocompletions_add("ls -a", sizeof("ls -a"), tree, &arena);
